...
@php
    ...
    $soalDownloadURL = route('dashboard-download', ['file' => Crypt::encrypt('ST3')]);
@endphp
...
@section('dashboard-content')
    ...
    <article class="sub-heading text-white" style="font-size: calc(8px + 1em);">
        Silahkan unduh soal tahap 3 <a href="{{ $soalDownloadURL }}" class="link">disini</a>.
    </article>  <br />
    <article class="sub-heading text-white" style="font-size: calc(8px + 1em);">
    ...
    {{ Form::open(['route' => 'submit-answer', 'files' => true, 'id' => 'SubmitForm']) }}
        ...
        <div class="form-group" style="margin-top: 12px;">
            {{ Form::label('FileSubmit', 'Pilih file', [
                'class' => 'btn btn-outline-success fit-content-btn',
