            ...
            <td style="box-sizing:border-box;max-width:100vw;padding:32px">
                <span>
                    ...
                    <p style="margin-bottom:1rem;box-sizing:border-box;color:white;font-size:16px;line-height:1.5em;margin-top:0;text-align:left">
                        Tekan tombol di bawah ini untuk memverifikasi email anda.
                    </p>
                                                        ...
                                                        <tbody>
                                                            <tr style="box-sizing:border-box;">
                                                                <td style="box-sizing:border-box;">
                                                                    <a href="{{ $url }}" style="box-sizing:border-box;border-radius:4px;color:#fff;display:inline-block;padding:0.375rem 0.75rem;overflow:hidden;text-decoration:none;border-bottom:1px solid #28a745;border-left:1px solid #28a745;border-right:1px solid #28a745;border-top:1px solid #28a745">Verifikasi Email</a>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                    ...
                    <p style="margin-bottom:1rem;box-sizing:border-box;color:white;font-size:16px;line-height:1.5em;margin-top:0;text-align:left">
                        Jika anda tidak membuat akun, abaikan pesan ini.
